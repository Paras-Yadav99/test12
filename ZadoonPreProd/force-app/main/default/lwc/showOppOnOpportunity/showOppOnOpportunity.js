...
export default class showOppOnOpportunity extends LightningElement {
    ...
    @track ShowNoOfOnWonOpp ;
    @track ShowNoOfOnLostOpp ;
    columns = columns;
        ...
        .then(result =>{
            if(result.isSuccess) {
                let parentWrapper = JSON.parse(result.response);
                    ...
                    this.ShowNoOfOnWonOpp = parentWrapper.totalNoOfcloseWonOpportunity;
                    this.ShowNoOfOnLostOpp = parentWrapper.totalNoOfcloseLostOpportunity;
